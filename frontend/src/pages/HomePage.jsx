...
import { HiOutlineChartBar, HiOutlineCurrencyRupee, HiOutlineClipboardCheck, HiOutlineStar, HiOutlineShieldCheck, HiOutlineArrowRight } from 'react-icons/hi';
        ...
        <div className="min-h-screen bg-white dark:bg-dark-950 transition-colors duration-300 selection:bg-primary-500/30">
            ...
            <main className="pt-32 pb-16 px-6">
                <div className="max-w-7xl mx-auto">
                    ...
                    {/* Features Grid */}
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-16 animate-slide-up" style={{ animationDelay: '200ms' }}>
                        {[
                            {
                            ...
                            <div key={i} className={`p-8 rounded-3xl border ${feat.bg} transition-transform hover:-translate-y-1 duration-300`}>
                        ...
                        <div className="p-8 rounded-3xl bg-gray-900 dark:bg-black border border-gray-800 flex flex-col justify-center items-start text-left min-h-[250px] relative overflow-hidden group">
                            ...
                            <h3 className="text-2xl font-bold text-white mb-3 relative z-10">100% Free & Open Source</h3>
                            <p className="text-gray-400 mb-6 relative z-10">Built with React, Node, and MongoDB. Own your mess data forever.</p>
                            <a href="https://github.com/soumyadeepsarkar-2004/MessWala" target="_blank" rel="noreferrer" className="text-primary-400 font-semibold flex items-center gap-2 hover:text-primary-300 transition-colors relative z-10">
