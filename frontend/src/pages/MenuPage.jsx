...
export default function MenuPage() {
  ...
  const fetchData = async () => {
    try {
      const [todayRes, weekRes] = await Promise.all([api.get('/menu/today'), api.get('/menu')]);
        ...
        <div className='glass-card-solid p-6 mb-8 animate-scale-in'>
          ...
          <form onSubmit={handleSave} className='space-y-4'>
            ...
            <div className='flex gap-3'>
              <button type='submit' className='btn-primary' id='menu-save'>
                Save Menu
              </button>
        ...
        <div className='p-6'>
          ...
          <div className='grid grid-cols-1 md:grid-cols-3 gap-4'>
            {['breakfast', 'lunch', 'dinner'].map((meal) => (
              <div
                key={meal}
                className='group relative p-5 rounded-xl bg-gradient-to-br from-gray-50 to-white dark:from-dark-700/50 dark:to-dark-800/50 border border-gray-100 dark:border-dark-600 hover:shadow-md transition-all duration-300 hover:-translate-y-0.5'
              >
                  ...
                  return (
                    ...
                    >
                      <td className='py-3 px-4'>
                        ...
                        {isToday && (
                          <span className='ml-2 badge bg-primary-100 dark:bg-primary-900/30 text-primary-600 dark:text-primary-300'>
                            Today
                          </span>
                        )}
                      </td>
