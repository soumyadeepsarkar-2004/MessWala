...
import { HiOutlineIdentification, HiOutlineHome, HiOutlinePhone, HiOutlineLocationMarker, HiOutlineCalendar, HiOutlineCheck } from 'react-icons/hi';
...
export default function OnboardingPage() {
    ...
    const fields = [
        { name: 'collegeId', label: 'College ID Number', icon: HiOutlineIdentification, type: 'text', placeholder: 'e.g. CSE2024001', required: true },
        { name: 'roomNumber', label: 'Room Number', icon: HiOutlineHome, type: 'text', placeholder: 'e.g. A-204', required: true },
        { name: 'phone', label: 'Phone Number', icon: HiOutlinePhone, type: 'tel', placeholder: '+91 98765 43210', required: true },
        { name: 'address', label: 'Address', icon: HiOutlineLocationMarker, type: 'text', placeholder: 'Your home address' },
            ...
            <div className="w-full max-w-lg relative animate-fade-in">
                <div className="text-center mb-8">
                    ...
                    <p className="text-gray-500 dark:text-gray-400 mt-2">
                        Hi <span className="font-semibold text-primary-500">{user?.name}</span>, fill in your college details to continue
                    </p>
                </div>
