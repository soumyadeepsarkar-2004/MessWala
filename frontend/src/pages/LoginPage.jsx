...
import { HiOutlineMail, HiOutlineLockClosed, HiOutlineAcademicCap, HiOutlineShieldCheck } from 'react-icons/hi';
            ...
            <div className="w-full max-w-md relative animate-fade-in">
                ...
                <div className="flex mb-6 bg-gray-100 dark:bg-dark-800 rounded-xl p-1">
                    <button
                        ...
                        className={`flex-1 flex items-center justify-center gap-2 py-2.5 rounded-lg text-sm font-semibold transition-all duration-300 ${tab === 'student'
                    ...
                    <button
                        ...
                        className={`flex-1 flex items-center justify-center gap-2 py-2.5 rounded-lg text-sm font-semibold transition-all duration-300 ${tab === 'admin'
                                ? 'bg-white dark:bg-dark-700 text-primary-600 dark:text-primary-400 shadow-sm'
                                : 'text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200'
                            }`}
                    >
                    ...
                    {tab === 'student' ? (
                        <div className="space-y-6">
                            <div className="text-center">
                                <h2 className="text-lg font-bold text-gray-900 dark:text-white mb-1">Student Sign In</h2>
                            ...
                            <p className="text-xs text-center text-gray-400 dark:text-gray-500">
                                New students will need to complete their profile after sign-in.<br />
                        ...
                        <form onSubmit={handleAdminLogin} className="space-y-5">
                            <div className="text-center mb-2">
                                <h2 className="text-lg font-bold text-gray-900 dark:text-white mb-1">Admin / Manager Login</h2>
                                <p className="text-sm text-gray-500 dark:text-gray-400">
