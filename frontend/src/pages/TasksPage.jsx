      ...
      <div className='flex flex-col sm:flex-row sm:items-center justify-between mb-6 animate-fade-in'>
        <div>
          ...
          <p className='text-gray-500 dark:text-gray-400 mt-1'>
            Manage committee tasks and responsibilities
          </p>
        </div>
        <button
          onClick={() => {
        ...
        {tasks.length === 0 ? (
          ...
          tasks.map((task, i) => {
            ...
            return (
              <div
                key={task._id}
                className={`glass-card-solid overflow-hidden transition-all duration-700 animate-slide-up ${
                  isAnimating
                  ...
                  <div className='flex items-start gap-4'>
                    ...
                    <div className='flex-1 min-w-0'>
                      <div className='flex items-center gap-2 flex-wrap'>
                        <h3
                          className={`font-semibold text-gray-900 dark:text-white transition-all duration-500 ${
                        ...
                        <span
                          className={`inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-xs font-medium border ${priority.color}`}
                        >
                      ...
                      <div className='flex items-center gap-4 mt-2 text-xs'>
                        {task.dueDate && (
                          <span
                            className={`flex items-center gap-1 font-medium ${dueDateColors[dueDateStatus] || 'text-gray-400'}`}
                          >
                            ...
                            {dueDateStatus === 'today'
                              ...
                              : dueDateStatus === 'tomorrow'
                                ...
                                : dueDateStatus === 'overdue'
                                  ? `Overdue: ${new Date(task.dueDate + 'T00:00').toLocaleDateString('en-IN', { day: 'numeric', month: 'short' })}`
