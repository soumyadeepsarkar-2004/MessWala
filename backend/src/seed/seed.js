...
async function seed() {
  try {
    ...
    const users = await User.create([
      ...
      {
        name: 'Arjun Sharma',
        email: 'arjun@messwala.com',
        password: 'student123',
        role: 'student',
        roomNumber: 'B-201',
        collegeId: 'CSE2024001',
        phone: '9876543210',
        messNumber: '1',
        isApproved: true,
        profileComplete: true,
      ...
      {
        name: 'Priya Patel',
        email: 'priya@messwala.com',
        password: 'student123',
        role: 'student',
        roomNumber: 'B-202',
        collegeId: 'CSE2024002',
        phone: '9876543211',
        messNumber: '1',
        isApproved: true,
        profileComplete: true,
      ...
      {
        name: 'Rahul Kumar',
        email: 'rahul@messwala.com',
        password: 'student123',
        role: 'student',
        roomNumber: 'B-203',
        collegeId: 'CSE2024003',
        phone: '9876543212',
        messNumber: '2',
        isApproved: true,
        profileComplete: true,
      ...
      {
        name: 'Sneha Gupta',
        email: 'sneha@messwala.com',
        password: 'student123',
        role: 'student',
        roomNumber: 'C-301',
        collegeId: 'CSE2024004',
        phone: '9876543213',
        messNumber: '2',
        isApproved: true,
        profileComplete: true,
      ...
      {
        name: 'Vikram Singh',
        email: 'vikram@messwala.com',
        password: 'student123',
        role: 'student',
        roomNumber: 'C-302',
        collegeId: 'CSE2024005',
        phone: '9876543214',
        messNumber: '1',
        isApproved: true,
        profileComplete: true,
      ...
      {
        name: 'Ananya Das',
        email: 'ananya@messwala.com',
        password: 'student123',
        role: 'student',
        roomNumber: 'C-303',
        collegeId: 'CSE2024006',
        phone: '9876543215',
        messNumber: '1',
        isApproved: true,
        profileComplete: true,
      ...
      {
        name: 'Rohan Mehta',
        email: 'rohan@messwala.com',
        password: 'student123',
        role: 'student',
        roomNumber: 'D-401',
        collegeId: 'CSE2024007',
        phone: '9876543216',
        messNumber: '2',
        isApproved: true,
        profileComplete: true,
    ...
    for (let dayOffset = 59; dayOffset >= 0; dayOffset--) {
      ...
      const dailyExpenses = [
        {
          category: 'vegetables',
          amount: randomBetween(800, 2000),
          description: 'Daily vegetables from market',
        },
      ...
      if (d.getDate() === 1) {
        dailyExpenses.push({
          ...
          description: 'Cook and helper salary',
        });
      }
      ...
      if (d.getDay() === 1) {
        dailyExpenses.push({
          ...
          description: 'Weekly spice restock',
        });
      }
    ...
    const taskData = [
      {
        title: 'Order vegetables for next week',
        description: 'Contact Ramesh vendor for bulk veggies order',
        priority: 'high',
      ...
      {
        title: 'Clean kitchen exhaust',
        description: 'Monthly exhaust cleaning due',
        priority: 'medium',
      ...
      },
      {
        ...
        description: 'Compile all expenses and submit to warden',
        priority: 'high',
        dueDate: new Date(Date.now() + 1 * 86400000).toISOString().split('T')[0],
        assignedTo: treasurer._id,
        createdBy: users[0]._id,
      },
      {
        title: 'Fix dining hall fan',
        description: 'Fan #3 in the dining hall is not working',
        priority: 'low',
      ...
      {
        title: 'Update next week menu',
        description: 'Plan and update the mess menu for next week',
        priority: 'medium',
      ...
      {
        title: 'Collect mess fees',
        description: 'Collect pending mess fees from 5 students',
        priority: 'high',
      ...
      {
        title: 'Restock disposable plates',
        description: 'Buy paper plates and cups for events',
        priority: 'low',
      ...
      {
        title: 'Organize feedback meeting',
        description: 'Monthly mess committee meeting with students',
        priority: 'medium',
