...
export default function AdminSetupPage() {
  ...
  const handleAddCategory = () => {
    ...
    setSelectedCategories([...selectedCategories, { ...customCategory, color: 'bg-gray-100' }]);
  ...
  const handleToggleMeal = (idx) => {
    setSelectedMeals(
      selectedMeals.map((meal, i) => (i === idx ? { ...meal, enabled: !meal.enabled } : meal)),
    );
  };
      ...
      <div className='max-w-2xl mx-auto'>
        ...
        <div className='text-center mb-10'>
          ...
          <p className='text-gray-600 dark:text-gray-300'>
            Let's set up your mess management system
          </p>
        </div>
                ...
                <div className='p-4 border-2 border-dashed border-gray-300 dark:border-dark-600 rounded-lg'>
                  ...
                  <div className='grid grid-cols-3 gap-2 mb-2'>
                    <input
                      ...
                      onChange={(e) =>
                        setCustomCategory({ ...customCategory, emoji: e.target.value })
                      }
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setCustomCategory({ ...customCategory, label: e.target.value })
                      }
                      className='px-2 py-1 rounded border border-gray-200 dark:border-dark-700 bg-white dark:bg-dark-800 text-gray-900 dark:text-white text-sm outline-none focus:ring-2 focus:ring-primary-500'
                    />
                  </div>
            ...
            <div className='animate-fade-in'>
              ...
              <div className='space-y-3'>
                {PRESET_MEALS.map((meal, idx) => (
                  <label
                    key={idx}
                    className='flex items-center p-4 border border-gray-200 dark:border-dark-700 rounded-lg hover:bg-gray-50 dark:hover:bg-dark-800 cursor-pointer transition-colors'
                  >
                    <input
                      type='checkbox'
                      defaultChecked
