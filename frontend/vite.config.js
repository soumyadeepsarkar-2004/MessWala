      ...
      output: {
        manualChunks(id) {
          ...
          if (
            ...
            id.includes('PendingApprovalPage') ||
            id.includes('ForgotPasswordPage')
          ) {
            return 'pages-auth';
          }
          if (
            id.includes('DashboardPage') ||
            id.includes('AttendancePage') ||
          ...
          if (
            id.includes('FeedbackPage') ||
            id.includes('MenuPage') ||
            id.includes('TasksPage') ||
            id.includes('StudentManagementPage')
          ) {
            return 'pages-other';
          }
        },
